...
class PlansTab:
    def __init__(self, notebook, data_dir):
        ...
        ttk.Label(frame, text="🗓 Wygenerowane plany lekcji",
    ...
    # ===================================================
    #   DODAWANIE NOWEGO PUSTEGO PLANU
    # ===================================================
    def add_plan(self):
    ...
    def open_plan_window(self, klasa, editable=False):
        ...
        ttk.Label(win, text=f"Plan lekcji — klasa {klasa}",
                  font=("Segoe UI", 14, "bold")).pack(pady=10)
        ...
        table.column("nauczyciel", width=140)
    ...
    def edit_lesson(self, table, klasa):
        ...
        ttk.Label(win, text=f"Dzień: {d}").pack(pady=5)
        ...
        def save_edit():
            # znajdź w planie
            for lesson in plan[d]:
                if lesson["godzina"] == g and lesson["przedmiot"] == p and lesson["nauczyciel"] == n:
    ...
    def delete_lesson(self, table, klasa):
        ...
        values = table.item(sel[0])["values"]
        d, g, p, n, s = values   # dzień, godzina, przedmiot, nauczyciel, sala

        if not messagebox.askyesno("Usuń lekcję",
                                f"Czy na pewno usunąć lekcję o {g}? "
        ...
        # 🔵 ZNAJDŹ TEGO KONKRETNEGO SLOTA I WYCZYŚĆ GO
        for lesson in plan[d]:
            if lesson["godzina"] == g:
        ...
        table.item(sel[0], values=(d, g, None, None, None))

    # ===================================================
    #   USUWANIE CAŁEGO PLANU
    # ===================================================
    def delete_plan(self):
        ...
        if not messagebox.askyesno("Usuń plan",
                                   f"Czy na pewno usunąć plan klasy {klasa}?"):
            return
        ...
        try:
            ...
            messagebox.showerror("Błąd", f"Nie można usunąć planu:\n{e}")
